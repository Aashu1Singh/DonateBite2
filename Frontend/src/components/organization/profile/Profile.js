...
export default function Profile() {
  ...
  const [organization, setOrganization] = useState({
    registrationDate: "2022-09-27T12:20:02.029+00:00",
  });
              ...
              <div className="row gx-4 mb-2">
                <div className="col-auto">
                  <div className="avatar avatar-xl position-relative">
                    ...
                    <i className="material-icons fs-1 position-relative text-secondary">
                      apartment
                    </i>
                  </div>
                </div>
                      ...
                      <div className="nav-wrapper position-relative end-0">
                        ...
                        >
                          <li className="nav-item">
                            <Link
                              className="nav-link mb-0 px-0 py-1 text-primary"
                              to="#"
                            >
                      ...
                      <div className="card-body p-3">
                        <ul className="list-group">
                          ...
                          <li className="list-group-item border-0 ps-0 text-sm">
                            ...
                            &nbsp;{" "}
                            {
                              // new Date(organization?.registrationDate)
                              //   .toISOString()
                              //   .split("T")[0]
                            }
                          </li>
                  ...
                  <div className="col-12 col-md-6 col-xl-4">
                    <div className="card card-plain h-100">
                      ...
                      <div className="card-body p-3">
                        <ul className="list-group">
                          <li className="list-group-item border-0 ps-0 pt-0 text-sm">
                            <h6 className="mb-0 fs-6">President's Details</h6>
                          </li>
                          <li className="list-group-item border-0 ps-0 pt-0 text-sm">
                            <strong className="text-dark">Name:</strong> &nbsp;{" "}
                          ...
                          <li className="list-group-item border-0 ps-0 text-sm">
                            ...
                            &nbsp; {organization?.presidentContactNumber}
                          </li>
                          <li className="list-group-item border-0 ps-0 text-sm">
                            <strong className="text-dark">Email:</strong> &nbsp;{" "}
                            {organization?.presidentEmail}
                          </li>

                          <li className="list-group-item border-0 ps-0 pt-0 text-sm mt-3">
                            <h6 className="mb-0 fs-6">Secretary's Details</h6>
                          </li>
                          <li className="list-group-item border-0 ps-0 pt-0 text-sm">
                            <strong className="text-dark">Name:</strong> &nbsp;{" "}
                          ...
                          <li className="list-group-item border-0 ps-0 text-sm">
                            <strong className="text-dark">Mobile:</strong>{" "}
                            &nbsp; {organization?.secretaryContactNumber}
                          </li>
                          <li className="list-group-item border-0 ps-0 text-sm">
                            <strong className="text-dark">Email:</strong> &nbsp;{" "}
                            {organization?.secretaryEmail}
                          </li>
                        </ul>
                      </div>
                    </div>
